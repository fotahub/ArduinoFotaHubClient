...
void firmwareUpdateInfoReader_run(void)
{
  ...
  {
    printf_("Firmware update request towards version %s received\n", updateVersion);
      ...
      switch (event)
      {
        case FirmwareUpdateInfoParser_characterReceived__event:
        {
          ...
          if ((*((uint8_t *)((arguments[0])))) != COLON && isspace((*((uint8_t *)((arguments[0]))))) == 0 && instance->characterIdx >= MAX_DEMO_FIRMWARE_UPDATE_VERSION_LENGTH - 1) 
          {
             ...
             * transition actions
             */
            printf_("Received firmware update version too long (max. length = %hhu)\n", MAX_DEMO_FIRMWARE_UPDATE_VERSION_LENGTH);
          ...
          if ((*((uint8_t *)((arguments[0])))) == COLON && instance->characterIdx == 0) 
          {
             ...
             * transition actions
             */
            printf_("Firmware update request with missing version received\n");
          ...
          if ((*((uint8_t *)((arguments[0])))) == LF && instance->characterIdx == 0) 
          {
             ...
             * transition actions
             */
            printf_("Empty firmware update request received\n");
            instance->characterIdx = 0;
          ...
          if ((*((uint8_t *)((arguments[0])))) == LF && instance->characterIdx > 0) 
          {
             ...
             * transition actions
             */
            printf_("Firmware update request with missing verification data received\n");
